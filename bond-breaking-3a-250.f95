...
! cut -c3-35 file > qcoord.dat
        ...
        integer, parameter :: rows=7500,columns=104
...
!        +(z(i,93)-z(i,104))**2)
      ...
      if (r12(i)  .ge. 6.0) then
        write (17,*) 'r12, ', r12(i),  i*0.250E-14
        endif
      if (r13(i) .ge. 6.0) then
        write(17,*)'r13, ',r13(i),i*0.250E-14
        endif
      if (r26(i) .ge. 6.0) then
        write(17,*) 'r26, ', r26(i),  i*0.250E-14
        endif
      if (r67(i)  .ge. 6.0) then
        write (17,*) 'r67, ', r67(i),  i*0.250E-14
        endif
      if (r73(i) .ge. 6.0) then
        write(17,*)'r73, ',r73(i),i*0.250E-14
        endif
      if (r713(i) .ge. 6.0) then
        write(17,*) 'r713, ', r713(i),  i*0.250E-14
        endif
      if (r712(i) .ge. 6.0) then
        write(17,*) 'r712, ', r712(i),  i*0.250E-14
        endif
      if (r39(i) .ge. 6.0) then
        write(17,*)'r39, ',r39(i),i*0.250E-14
        endif
      if (r915(i) .ge. 6.0) then
        write(17,*)'r915, ',r915(i),i*0.250E-14
        endif
      if (r1517(i) .ge. 6.0) then
        write(17,*)'r1517, ',r1517(i),i*0.250E-14
        endif
      if (r1719(i) .ge. 6.0) then
        write(17,*)'r1719, ',r1719(i),i*0.250E-14
        endif
      if (r1923(i) .ge. 6.0) then
        write(17,*)'r1923, ',r1923(i),i*0.250E-14
        endif
      if (r1720(i) .ge. 6.0) then
        write(17,*)'r1720, ',r1720(i),i*0.250E-14
        endif
      if (r2036(i) .ge. 6.0) then
        write(17,*)'r2036, ',r2036(i),i*0.250E-14
        endif
      if (r3638(i) .ge. 6.0)then
        write(17,*)'r3638, ',r3638(i),i*0.250E-14
        endif
      if (r3840(i) .ge. 6.0)then
        write(17,*)'r3840, ',r3840(i),i*0.250E-14
        endif
      if (r4044(i) .ge. 6.0)then
        write(17,*)'r4044, ',r4044(i),i*0.250E-14
        endif
!      if (r49102(i) .ge. 6.0) then
!        write(17,*)'r49102, ',r49102(i),i*0.250E-14
!      endif
      if (r5456(i) .ge. 6.0) then
        write(17,*)'r5456, ',r5456(i),i*0.250E-14
      endif
      if (r5254(i) .ge. 6.0) then
        write(17,*)'r5254, ',r5254(i),i*0.250E-14
      endif
      if (r60102(i) .ge. 6.0) then
        write(17,*)'r60102, ',r60102(i),i*0.250E-14
      endif
!      if (r90102(i) .ge. 6.0) then
!        write(17,*)'r90102, ',r90102(i),i*0.250E-14
!        endif
!      if (r93104(i) .ge. 6.0) then
!        write(17,*)'r93104, ',r93104(i),i*0.250E-14
!      endif
      if (r3435(i) .ge. 6.0) then
        write(17,*)'r3435, ',r3435(i),i*0.250E-14
        endif
      if (r3841(i) .ge. 6.0) then
        write(17,*)'r3841, ',r3841(i),i*0.250E-14
        endif
      if (r4152(i) .ge. 6.0) then
        write(17,*)'r4152, ',r4152(i),i*0.250E-14
        endif
      if (r5457(i) .ge. 6.0) then
        write(17,*)'r5457, ',r5457(i),i*0.250E-14
        endif
      if (r5762(i) .ge. 6.0) then
        write(17,*)'r5762, ',r5762(i),i*0.250E-14
        endif
      if (r6466(i) .ge. 6.0) then
        write(17,*)'r6466, ',r6466(i),i*0.250E-14
        endif
      if (r6364(i) .ge. 6.0) then
        write(17,*)'r6364, ',r6364(i),i*0.250E-14
        endif
      if (r6670(i) .ge. 6.0) then
        write(17,*)'r6670, ',r6670(i),i*0.250E-14
        endif
      if (r79102(i) .ge. 6.0) then
        write(17,*)'r79102, ',r79102(i),i*0.250E-14
        endif
      if (r7071(i) .ge. 6.0) then
        write(17,*)'r7071, ',r7071(i),i*0.250E-14
        endif
      if (r7175(i) .ge. 6.0) then
        write(17,*)'r7175, ',r7175(i),i*0.250E-14
        endif
      if (r7579(i) .ge. 6.0) then
        write(17,*)'r7579, ',r7579(i),i*0.250E-14
        endif
      if (r62103(i) .ge. 6.0) then
        write(17,*)'r62103, ',r62103(i),i*0.250E-14
        endif
      if (r7380(i) .ge. 6.0) then
        write(17,*)'r7380, ',r7380(i),i*0.250E-14
        endif
      if (r8185(i) .ge. 6.0) then
        write(17,*)'r8185, ',r8185(i),i*0.250E-14
        endif
        if (r8081(i) .ge. 6.0) then
        write(17,*)'r8081, ',r8081(i),i*0.250E-14
        endif
      if (r8183(i) .ge. 6.0) then
        write(17,*)'r8183, ',r8183(i),i*0.250E-14
        endif
      if (r8396(i) .ge. 6.0) then
        write(17,*)'r8396, ',r8396(i),i*0.250E-14
        endif
      if (r9697(i) .ge. 6.0) then
        write(17,*)'r9697, ',r9697(i),i*0.250E-14
        endif  
        enddo
        stop
        end
