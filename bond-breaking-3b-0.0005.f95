...
! cut -c3-35 file > qcoord.dat
        ...
        dimension r79102(rows), r112(rows)
...
!       C-C bonds (backbone)
        ...
        -z(i,2))**2)
        r112(i)= sqrt ((x(i,1)-x(i,12))**2+(y(i,1)-y(i,12))**2+(z(i,1)&
        -z(i,12))**2)
...
!       C-N    (backbone)
        ...
        +(z(i,11)-z(i,102))**2)
!       N-C     (backbone)
        r1317(i)= sqrt ((x(i,13)-x(i,17))**2+(y(i,13)-y(i,17))**2&
         + (z(i,13)-z(i,17))**2)        
        r1315(i)= sqrt ((x(i,13)-x(i,15))**2+(y(i,13)-y(i,15))**2&
        +(z(i,13)-z(i,15))**2)
!       sidechain
        r3034(i)= sqrt ((x(i,30)-x(i,34))**2+(y(i,30)-y(i,34))**2&
        +(z(i,30)-z(i,34))**2)
        r2930(i)= sqrt ((x(i,29)-x(i,30))**2+(y(i,29)-y(i,30))**2&
        +(z(i,29)-z(i,30))**2)
        r4950(i)= sqrt ((x(i,49)-x(i,50))**2+(y(i,49)-y(i,50))**2&
        +(z(i,49)-z(i,50))**2)
        r5263(i)= sqrt ((x(i,52)-x(i,63))**2+(y(i,52)-y(i,63))**2&
        +(z(i,52)-z(i,63))**2)
...
!91      format (27f9.3)
      if (r12(i)  .ge. 6.0) then
        write (17,*) 'r12, ', r12(i),  i*0.065E-14
        endif
        if (r112(i)  .ge. 6.0) then
        write (17,*) 'r112, ', r112(i),  i*0.065E-14
        endif
        if (r13(i)  .ge. 6.0) then
        write (17,*) 'r13, ', r13(i),  i*0.065E-14
        endif
      if (r36(i) .ge. 6.0) then
        write(17,*)'r36, ',r36(i),i*0.065E-14
        endif
      if (r59(i) .ge. 6.0) then
        write(17,*) 'r59, ', r59(i),  i*0.065E-14
        endif
      if (r1213(i) .ge. 6.0) then
        write(17,*)'r1213, ',r1213(i),i*0.065E-14
        endif
      if (r9102(i) .ge. 6.0) then
        write(17,*)'r9102, ',r9102(i),i*0.065E-14
        endif
      if (r11102(i) .ge. 6.0) then
        write(17,*)'r11102, ',r11102(i),i*0.065E-14
        endif
      if (r1317(i) .ge. 6.0) then
        write(17,*)'r1317, ',r1317(i),i*0.065E-14
        endif
      if (r1315(i) .ge. 6.0)then 
        write(17,*)'r1315, ',r1315(i),i*0.065E-14
        endif
      if (r3034(i) .ge. 6.0)then
        write(17,*)'r3034, ',r3034(i),i*0.065E-14
        endif
      if (r2930(i) .ge. 6.0) then
        write(17,*)'r2930, ',r2930(i),i*0.065E-14
        endif
      if (r4950(i) .ge. 6.0) then    
        write(17,*)'r4950, ',r4950(i),i*0.065E-14
        endif
      if (r5263(i) .ge. 6.0) then
        write(17,*)'r5263, ',r5263(i),i*0.065E-14
        endif
      if (r6364(i) .ge. 6.0) then
        write(17,*)'r6364, ',r6364(i),i*0.065E-14
        endif
      if (r6670(i) .ge. 6.0) then
        write(17,*)'r6670, ',r6670(i),i*0.065E-14
        endif
!      elseif (r72102(i) .ge. 6.0) then
!        write(17,*)'r72102, ',r72102(i),i*0.065E-14
      if (r7071(i) .ge. 6.0) then
        write(17,*)'r7071, ',r7071(i),i*0.065E-14
        endif
      if (r7579(i) .ge. 6.0) then
        write(17,*)'r7579, ',r7579(i),i*0.065E-14 
        endif
      if (r79102(i) .ge. 6.0) then
        write(17,*)'r79102, ',r79102(i),i*0.065E-14         
        endif
      if (r7380(i) .ge. 6.0) then
        write(17,*)'r7380, ',r7380(i),i*0.065E-14
        endif
      if (r8081(i) .ge. 6.0) then
        write(17,*)'r8081, ',r8081(i),i*0.065E-14
        endif
      if (r8185(i) .ge. 6.0) then
        write(17,*)'r8185, ',r8185(i),i*0.065E-14 
        endif
      if (r8183(i) .ge. 6.0) then
        write(17,*)'r8183, ',r8183(i),i*0.065E-14 
        endif
      if (r8396(i) .ge. 6.0) then
        write(17,*)'r8396, ',r8396(i),i*0.065E-14
        endif
      if (r9697(i) .ge. 6.0) then
        write(17,*)'r9697, ',r9697(i),i*0.065E-14 
        endif
